...
public class CreateFilesBasedonState {
    public static void main (String [] args) {
        ...
        Path inStateFile= Paths.get("C:\\Users\\Rita.DESKTOP-NDQVPRR\\OneDrive\\Bureau\\Objectoriented programming 2\\InStateCusts.txt");
        Path outStateFile= Paths.get("C:\\Users\\Rita.DESKTOP-NDQVPRR\\OneDrive\\Bureau\\Objectoriented programming 2\\OutOfStateCusts.txt");
        ...
        try {
            ...
            while(!(idString.equals(QUIT))) {
                ...
                if (state.equals(HOME_STATE)) {
                    fcIn.position((long) id * RECSIZE);
                    fcIn.write(buffer);
                }
                else {
                    fcOut.position((long) id * RECSIZE);
                    fcOut.write(buffer);
                }
